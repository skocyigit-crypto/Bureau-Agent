...
const TOPICS: HelpTopic[] = [
  ...
  // Intégrations
  {
    ...
    icon: Plug,
    title: "Connecter Google Workspace (Gmail)",
    keywords: ["google", "workspace", "gmail", "drive", "calendar", "agenda", "integration", "oauth", "connexion", "email", "mail"],
    href: "/google-workspace",
    steps: [
      "Dans le menu de gauche, cliquez sur Google Workspace (icône globe).",
      "Cliquez sur le bouton « Se connecter avec Google ».",
      "Dans la fenêtre Google, choisissez le compte Gmail à connecter.",
      "Autorisez les 3 accès demandés : Gmail, Agenda et Drive, puis cliquez sur « Autoriser ».",
      "De retour dans l'application, vos derniers emails, événements et fichiers s'affichent automatiquement.",
    ],
    tip: "Si Google affiche une erreur « 403 / accès refusé », ce n'est pas l'application : l'administrateur doit, une seule fois, activer les API Gmail/Agenda/Drive et publier l'écran de consentement dans Google Cloud Console. Voir le guide PDF « Connexion Google Workspace ».",
  },
  {
    id: "telephonie",
    category: "Intégrations",
