...
function RootLayoutNav() {
  return (
    <Stack screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen name="whatsapp" options={{ headerShown: false, presentation: "modal" }} />
      <Stack.Screen name="whatsapp-thread" options={{ headerShown: false, presentation: "modal" }} />
      ...
      <Stack.Screen name="smart-capture" options={{ headerShown: false, presentation: "modal" }} />
      <Stack.Screen name="depenses" options={{ headerShown: false, presentation: "modal" }} />
