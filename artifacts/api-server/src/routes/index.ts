...
import orgGoogleCredentialsRouter from "./org-google-credentials";
...
router.use(supportInboxRouter);
router.use(publicDemoChatRouter);
router.use(publicAppointmentsRouter);
...
router.use(orgGoogleCredentialsRouter);
