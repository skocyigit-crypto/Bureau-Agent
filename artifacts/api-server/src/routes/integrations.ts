...
const SOFTWARE_CATALOG: SoftwareIntegration[] = [
  ...
  },
  {
    ...
    name: "HubSpot",
    category: "crm",
    description: "Connecter votre CRM HubSpot pour gerer les contacts, deals et activites depuis Ajant Bureau.",
    status: "deconnecte",
    version: null,
    lastSync: null,
    features: [
  ...
  },
  {
    ...
    category: "communication",
    description: "Integrer Ajant Bureau avec Microsoft Teams pour les notifications et la collaboration.",
    status: "deconnecte",
    version: null,
    lastSync: null,
    features: [
  ...
  },
  {
    ...
    name: "Asana",
    category: "gestion_projet",
    description: "Connecter Asana pour synchroniser les taches et projets avec Ajant Bureau.",
    status: "deconnecte",
    version: null,
    lastSync: null,
    features: [
  ...
  },
  {
    ...
    name: "DocuSign",
    category: "documents",
    description: "Envoyer des documents a signer electroniquement directement depuis Ajant Bureau.",
    status: "deconnecte",
    version: null,
    lastSync: null,
    features: [
  ...
  },
  {
    ...
    category: "messagerie",
    description: "Synchroniser les e-mails et le calendrier Outlook avec Ajant Bureau.",
    status: "deconnecte",
    version: null,
    lastSync: null,
    features: [
  ...
  },
  {
    ...
    description: "Connecter Ajant Bureau a plus de 5000 applications via Zapier.",
    status: "deconnecte",
    version: null,
    lastSync: null,
    features: [
  ...
  },
  {
    ...
    name: "Jira",
    category: "gestion_projet",
    description: "Synchroniser les tickets et projets Jira avec les taches d'Ajant Bureau.",
    status: "deconnecte",
    version: null,
    lastSync: null,
    features: [
  ...
  },
  {
    ...
    name: "Intercom",
    category: "support",
    description: "Unifier le support client entre Intercom et Ajant Bureau.",
    status: "deconnecte",
    version: null,
    lastSync: null,
    features: [
