...
const GOOGLE_APPS = [
  ...
  { id: "docs", name: "Google Docs", description: "Traitement de texte collaboratif", icon: "file-text", color: "#4285F4", category: "documents", connector: null, scopes: ["https://www.googleapis.com/auth/documents"] },
  { id: "sheets", name: "Google Sheets", description: "Tableur collaboratif", icon: "table", color: "#0F9D58", category: "documents", connector: null, scopes: ["https://www.googleapis.com/auth/spreadsheets"] },
