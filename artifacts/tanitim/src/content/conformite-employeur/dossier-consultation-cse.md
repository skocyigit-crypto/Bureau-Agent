# Dossier d'information et de consultation du CSE

*Modèle à compléter par l'employeur. Le CSE doit être informé et consulté **préalablement** à la
décision de mettre en œuvre des moyens de contrôle de l'activité des salariés
(Code du travail, art. L2312-38).*

## 1. Objet de la consultation

Mise en œuvre, dans le logiciel de gestion Ajant Bureau, des fonctionnalités suivantes :

- [ ] pointage du temps de travail ;
- [ ] suivi de présence sur zones de travail via l'application mobile ;
- [ ] rapports d'activité et d'évaluation d'équipe assistés par IA.

## 2. Finalités poursuivies et nécessité

| Fonctionnalité | Finalité | Pourquoi un moyen moins intrusif ne suffit pas |
|---|---|---|
| Pointage | Décompte du temps de travail, respect des repos | [à compléter] |
| Présence sur zone | [à compléter] | [à compléter] |
| Rapports d'activité | [à compléter] | [à compléter] |
...
- Information individuelle préalable (voir la note d'information).
- Droits d'accès, de rectification et d'opposition : [contact].
- Durées de conservation : [tableau].
- Analyse d'impact : [réalisée le … / en cours].

## 5. Calendrier et avis

- Transmission du dossier au CSE : [date]
- Réunion de consultation : [date]
- Avis du CSE : [favorable / défavorable / observations], à annexer
- Mise en service envisagée : [date, postérieure à l'avis]
