...
export type ListProspectsParams = {
  statut?: ListProspectsStatut;
  limit?: number;
  offset?: number;
  search?: string;
  sortBy?: ListProspectsSortBy;
  sortOrder?: ListProspectsSortOrder;
};
...
export type ListFacturesSortBy =
  (typeof ListFacturesSortBy)[keyof typeof ListFacturesSortBy];

export const ListFacturesSortBy = {
  createdAt: "createdAt",
  numero: "numero",
  montantTtc: "montantTtc",
  statut: "statut",
