...
export const GetWeeklyReportResponse = zod.object({
  ...
  answerRate: zod.number().nullable(),
  avgDuration: zod.number().nullable(),
  newContacts: zod.number(),
  completedTasks: zod.number(),
  messagesReceived: zod.number(),
  peakHour: zod.number().nullable(),
  peakDay: zod.string().nullable(),
  comparisonPrevWeek: zod.object({
    callsDiff: zod.number().nullable(),
    answerRateDiff: zod.number().nullable(),
    durationDiff: zod.number().nullable(),
  }),
});
